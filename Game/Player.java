...
public class Player {
    ...
    private boolean isMirrored = false; // Neuer Spiegelsatus
    ...
    public void goToHeaven(Stage primaryStage) {
        if (isDeathScreenShown) {
            return; // Wenn der Deathscreen bereits angezeigt wurde, nichts tun
        }
        tetriAutoGame.gameOver = true;
        ...
        HimmelDeathScreen himmelDeathScreen = new HimmelDeathScreen(primaryStage, previousScene);
        himmelDeathScreen.show();
    }
    ...
    public boolean isMirrored() { return isMirrored; } // Getter für Spiegelsatus
    public void setMirrored(boolean mirrored) { this.isMirrored = mirrored; } // Setter für Spiegelsatus
}