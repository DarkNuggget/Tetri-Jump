...
public class TetriGui extends Application {
  ...
  private TetriAutoGame tetriAutoGame = null;
  ...
  // Methode um das HellDeathScreen zu öffnen
  // Methode um das HellDeathScreen zu öffnen
  public void openHellDeathScreen() {
    HellDeathScreen hellDeathScreen = new HellDeathScreen(primaryStage, primaryStage.getScene());
    hellDeathScreen.show();
  }
  
   public void openHimmelDeathScreen() {
    HimmelDeathScreen himmelDeathScreen = new HimmelDeathScreen(primaryStage, primaryStage.getScene());
