...
private void updateGame() {
    ...
    if (player.getPlayerY() < HEIGHT * TILE_SIZE) {
        ...
        // Spieler bleibt auf der untersten Position, aber fällt weiter nach unten
    ...
    // Überprüfen auf Kollisionen mit dem Tetromino und andere Spiel-Logik
...
//    spawnPlayerRandomly();
  ...
  private void startScoreCounter() {
        scoreTimer = new Timeline(new KeyFrame(Duration.seconds(1), e -> score++));
